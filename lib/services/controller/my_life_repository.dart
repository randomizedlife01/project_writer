...
class MyLifeRepository {
  Future<List<MyLifeStory>> readMyStory() async {
    try {
      final myLifeStory = await Amplify.DataStore.query(MyLifeStory.classType,
          sortBy: [MyLifeStory.YEAR.ascending(), MyLifeStory.SEASON.ascending(), MyLifeStory.MONTH.ascending()]);
